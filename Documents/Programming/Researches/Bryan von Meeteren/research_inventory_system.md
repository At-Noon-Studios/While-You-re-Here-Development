...
- [Fixed Inventory](#step-1)
- [Slot-Based Inventory (Array)](#step-2)
- [Dynamic Inventory (Lists)](#step-3)
- [Making Items](#step-4)
- [Do the items actually have to exist in the game world?](#step-5)
- [Using Unity UI or UI-Toolkit?](#step-6)
- [Potential questions for the gameplay team:](#step-7)


[This video](https://www.youtube.com/watch?v=pmBv0Cagx_o&list=WL) gives a beginner-friendly introduction about the 3 most common ways to design an inventory system.  
It helps you think about what kind of system you'd like to implement for your own game.
...
<a id="step-5"></a>
### Do the items actually have to exist in the game world?
If your items spend most of their time as real objects, consider using a GameObject-based inventory.  
